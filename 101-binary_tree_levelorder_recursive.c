 ...
 * @tree: Ponter to the root node of the tree to traverse.
 * @func: Ponter to a function to call for each node.
 */
 ...
 * @head: Ponter to head of linked list with nodes at one level.
 * @func: Ponter to a function to call for each node.
 */
void levels_rec(ll *head, void (*func)(int))
{
 ...
 * @head: Ponter to head of linked list where children will be appended.
...
/**
 * apnd - adds a new node at the end of a linkedlist
